  ...
  about: {
    educations: [
      ...
      },
      {
        ...
        detail: `전자공학 중에서도 프로그래밍이 재밌었다. 회로이론도 재밌었지만, 프로그래밍이 더 재밌었다.
        자료구조 하나는 좋은 수업을 들어서 기억에 잘 남아있다.`,
      },
    ],
    careers: [
      {
      ...
      },
      {
        ...
        ioT 디바이스와 통신해서 수신한 데이터를 시각화 해주는 서비스를 개발했다.
      ...
      },
      {
        ...
        detail: `배달의 민족을 서비스하는 우아한형제들에서 진행하는 교육형 인턴십.
        VanillaJS와 Express로 scratch 부터 만드는 방법을 배우는 중이다.`,
